...
print('++++++start+++++++')
wb = openpyxl.open("redgumpc.xlsx")
sheet = wb.active


driver.get('https://www.redgumpc.com.au/')
time.sleep(3)
Links=[]
...
for ll in lis:
    ...
    for p in proLink:
        ...
        for pr in PerPro:
            ...
            data.append(pr)
            try:
                name=driver.find_element_by_xpath('/html/body/div[5]/div/div[1]/div/div[2]/div[1]/h2').text
                print(name)
                data.append(name)
            except:
                data.append('N/A')
            
            Cata=Cata.replace('https://www.redgumpc.com.au/',' ')
            Cata=Cata.replace('.html',' ')
            print(Cata)
            data.append(Cata)
            subCat=subCat.replace('https://www.redgumpc.com.au/',' ')
            subCat=subCat.replace('.html',' ')
            print(subCat)
            data.append(subCat)
            
            try:
                arNu=driver.find_element_by_xpath('/html/body/div[5]/div/div[1]/div/div[2]/div[1]/div[1]/div[3]').text
                print(arNu)
                data.append(arNu)
            except:
                data.append('N/A')            
            ...
            try:
                price=driver.find_element_by_xpath('/html/body/div[5]/div/div[1]/div/div[2]/div[1]/div[2]/div[1]/span').text
                print(price)
                data.append(price)
            except:
                data.append('N/A')
            ...
            try:
                detail=driver.find_element_by_xpath('/html/body/div[5]/div/div[1]/div/div[2]/div[3]').text
                print(detail)
                data.append(detail)
            except:
                data.append('N/A')
            ...
            ext=driver.find_elements_by_xpath('/html/body/div[5]/div/div[1]/div/div[2]/div[3]/table/tbody/tr')
            print('Extra Info $$$$$$$$$$$$$$$$$$$$$$')
            for t in ext:
