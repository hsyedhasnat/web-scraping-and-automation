...
print('++++++start+++++++')
wb = openpyxl.open("kadiajewellery.xlsx")
sheet = wb.active
...
i=5
for ll in range(8):
    driver.get('https://www.kadiajewellery.com.au/')
    time.sleep(3)
    ...
    for p in proLink:
        ...
        while(1):
            ...
            for link in Plinks:
                try:
                    ...
                    href=div.find_element_by_class_name('product-thumb')
            ...
            try:
                driver.find_element_by_xpath('//*[@id="category-products"]/div[9]/div/div/ul/li[last()]').click()
        ...
        for pr in PerPro:
            ...
            data.append(pr)
            try:
                name=driver.find_element_by_xpath('/html/body/div[2]/div[2]/div/div[1]/div[3]/div/div[1]').text
                print(name)
                data.append(name)
            except:
                data.append('N/A')
            
            Cata=Cata.replace('https://www.kadiajewellery.com.au/',' ')
            Cata=Cata.replace('.html',' ')
            print(Cata)
            data.append(Cata)
            subCat=subCat.replace('https://www.kadiajewellery.com.au/',' ')
            subCat=subCat.replace('.html',' ')
            print(subCat)
            data.append(subCat)
            
            try:
                arNu=driver.find_element_by_xpath('/html/body/div[2]/div[2]/div/div[1]/div[3]/div/span').text
                print(arNu)
                data.append(arNu)
            except:
                data.append('N/A')            
            ...
            try:
                price=driver.find_element_by_xpath('/html/body/div[2]/div[2]/div/div[1]/div[3]/div/div[3]/span').text
                print(price)
                data.append(price)
            except:
                data.append('N/A')
            ...
            ext=driver.find_elements_by_xpath('/html/body/div[2]/div[2]/div/div[1]/div[3]/div/table/tbody/tr')
            print('Extra Info $$$$$$$$$$$$$$$$$$$$$$')
            for t in ext:
