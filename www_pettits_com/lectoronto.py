...
i=2
for ll in range(8):
    driver.get('https://www.jimhughes.com.au/')
    time.sleep(3)
    ...
    for p in proLink:
        ...
        for pr in PerPro:
            ...
            Cata=Cata.replace('https://www.jimhughes.com.au/',' ')
            Cata=Cata.replace('.html',' ')
            print(Cata)
            data.append(Cata)
            subCat=subCat.replace('https://www.jimhughes.com.au/',' ')
            ...
            try:
                detail=driver.find_element_by_xpath('/html/body/div[2]/div[2]/div/div[1]/div[3]/div/div[2]').text
                print(detail)
                data.append(detail)
            except:
                data.append('N/A')
