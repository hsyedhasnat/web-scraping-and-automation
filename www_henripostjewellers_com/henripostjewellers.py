...
print('++++++start+++++++')
wb = openpyxl.open("henripostjewellers.xlsx")
sheet = wb.active
...
i=4
for ll in range(8):
    print("start",2,"_-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-__-_-_-_")
    driver.get('https://www.henripostjewellers.com.au/')
    time.sleep(3)
    print(i,'+_+_+_+_+_+_+_+_+_+_+_+')
    
    llis=driver.find_element_by_xpath('/html/body/div[3]/div/div/div/ul/li['+str(i)+']')
    i=i+1
    proLink=[]
    ...
    for p in proLink:
        ...
        while(1):
            ...
            for link in Plinks:
                try:
                    ...
                    href=link.find_element_by_class_name('thumb_product')
        ...
        for pr in PerPro:
            ...
            data.append(pr)
            try:
                name=driver.find_element_by_xpath('/html/body/div[4]/div[2]/div/div[1]/div[3]/div/h2').text
                print(name)
                data.append(name)
            except:
                data.append('N/A')
            
            Cata=Cata.replace('https://www.henripostjewellers.com.au/',' ')
            Cata=Cata.replace('.html',' ')
            print(Cata)
            data.append(Cata)
            subCat=subCat.replace('https://www.henripostjewellers.com.au/',' ')
            subCat=subCat.replace('.html',' ')
            print(subCat)
            data.append(subCat)
            
            try:
                arNu=driver.find_element_by_xpath('/html/body/div[4]/div[2]/div/div[1]/div[2]/span').text
                print(arNu)
                data.append(arNu)
            except:
                data.append('N/A')            
            ...
            try:
                price=driver.find_element_by_xpath('/html/body/div[4]/div[2]/div/div[1]/div[3]/div/div[3]/div[1]/span').text
                print(price)
                data.append(price)
            except:
                data.append('N/A')
            ...
            ext=driver.find_elements_by_xpath('/html/body/div[4]/div[2]/div/div[1]/div[3]/div/table/tbody/tr')
            print('Extra Info $$$$$$$$$$$$$$$$$$$$$$')
            for t in ext:
            ...
            try:   
                sheet.append(data)
                wb.save("henripostjewellers.xlsx")
            except:
                pass
